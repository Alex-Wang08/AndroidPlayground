...
import com.example.androidplayground.activities.spotify.exoplayer.callback.MusicNotificationListener
import com.example.androidplayground.activities.spotify.exoplayer.callback.MusicPlaybackPreparer
import com.example.androidplayground.activities.spotify.exoplayer.callback.MusicPlayerEventListener
...
//        exoPlayer.setMediaItem(songs.map { it.to })
        ...
        when (parentId) {
            MEDIA_ROOT_ID -> {
                val resultsSent = firebaseMusicSource.whenReady { isInitialized ->
                    if (isInitialized) {
                        result.sendResult(firebaseMusicSource.asMediaItems().toMutableList())
